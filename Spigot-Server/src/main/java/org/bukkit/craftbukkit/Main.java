...
import io.superloader.SuperLoaderJVMCheek;
    ...
    public static void main(String[] args) {
        ...
        OptionParser parser = new OptionParser() {
            {
                ...
                acceptsAll(asList("L","luascripts"))
                        .withRequiredArg()
                        .ofType(File.class)
                        .defaultsTo(new File("luascripts"))
                        .describedAs("lua script directory");

                acceptsAll(asList("J","jsscripts"))
                        .withRequiredArg()
                        .ofType(File.class)
                        .defaultsTo(new File("jsscripts"))
                        .describedAs("javascript directory");
                acceptsAll(asList("P","pysdk"))
                        .withRequiredArg()
                        .ofType(File.class)
                        .defaultsTo(new File("pysdk"))
                        .describedAs("python sdk directory");
            }
        };
        ...
        if ((options == null) || (options.has("?"))) {
            ...
            try {
                ...
                SuperLoaderJVMCheek.main(options);
            } catch (Throwable t) {
                t.printStackTrace();
            }
        }
